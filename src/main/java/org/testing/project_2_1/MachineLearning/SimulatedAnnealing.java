...
public class SimulatedAnnealing {
    private double temperature;         // Initial temperature for the annealing process.
    private double coolingRate;         // Cooling rate to reduce temperature gradually.
    private int iterations;             // Number of iterations to run the algorithm.
    private double[] bestSolution;      // Best solution found during optimization.
    private double performance;         // Performance score of the best solution.
    private double[] oldCoefficients = {1, 3, 1}; // Reference coefficients for the opposing agent.

    /**
     * Constructs a SimulatedAnnealing instance with specified parameters.
     *
     * @param temperature Initial temperature for the annealing process.
     * @param coolingRate Rate at which the temperature decreases per iteration.
     * @param iterations  Total number of iterations to run the optimization.
     */
    ...
    public double[] optimize() {
        double[] currentSolution = {1, 1, 1}; // Initialize with default coefficients.
        bestSolution = currentSolution.clone(); // Start with the current solution as the best.
        double currentPerformance = evaluate(currentSolution, 10); // Evaluate initial performance.
